  ...
  function renderTopic(){
    ...
    $("topic-body").querySelectorAll(".sp-item").forEach(item=>{
      ...
      item.querySelector('[data-act="play"]').addEventListener("click",e=>{e.stopPropagation();
        ...
        speakBest(p.passage,{rate:.92,onend:()=>b.textContent="▶ 지문 듣기"});});
      ...
      item.querySelector('[data-act="dlaudio"]').addEventListener("click",e=>{e.stopPropagation();ttsDownload(p.passage,p.title);});
    });
  }
